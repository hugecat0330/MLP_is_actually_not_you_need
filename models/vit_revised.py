...
class MLP(nn.Module):
    def __init__(self, in_features, hidden_features=None, act_layer=nn.GELU, bias=True, drop=0.):
        super().__init__()
        ...
        # self.fc2 = nn.Linear(hidden_features, in_features, bias=bias[1])
        self.max2 = nn.MaxPool1d(6, stride=4, padding=1)
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
        ...
        self.mlp = MLP(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, bias=True, drop=drop)
    def forward(self, x):
...
@register_model
def vit_small_patch16_224_(pretrained=False, **kwargs):
    """ ViT-Small (ViT-S/16)
